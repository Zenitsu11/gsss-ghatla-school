export const SHALA_DARPAN_SCHOOL = {
  nicSdId: "215691",
  udiseCode: "08060806901",
  name: "राजकीय उच्च माध्यमिक विद्यालय, घातला",
  district: "अलवर",
  block: "उमरैन",
} as const;
...
// Public-safe fields from the school's authorized Shala Darpan staff export.
// Do not add Aadhaar, PAN, mobile, address, DOB, or other private fields here.
export const SHALA_DARPAN_STAFF: ShalaDarpanStaff[] = [
